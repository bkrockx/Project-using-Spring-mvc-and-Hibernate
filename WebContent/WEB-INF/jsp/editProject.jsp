...
<c:url var="saveUrl" value="/project3/edit?id=${projectAttribute.projectId}" />
...
<form:form modelAttribute="projectAttribute"  method="POST" action="${saveUrl}">
	...
	<tbody>
		...
		<tr>
		  ...
		  <p><a href="${addCUrl}">Map employee</a></p> 
...
<table border='1.5' width='600' cellpadding='1' cellspacing='1'>
	...
	<tbody>
		...
		<c:if test="${empty projectAttribute.client}"> 
		  <p><a href="${addDUrl}">Map client</a></p>
		 </c:if> 
